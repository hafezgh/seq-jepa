...
### OOD images available at https://huggingface.co/datasets/Hafez/3DIEBench-OOD
...
### Download ImageNet1k saliency maps from hugging face https://huggingface.co/datasets/Hafez/ImageNet1k-Saliency-Maps
class Imagenet1k_Sal(Dataset):
    def __init__(self, data_path_img, data_path_sal, split, full_img_transform, full_img_size=224, patch_size=64,
        ...
        self.full_img_trans = full_img_transform
